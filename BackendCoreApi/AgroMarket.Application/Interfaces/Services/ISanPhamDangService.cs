...
namespace AgroMarket.Application.Interfaces.Services
{
    public interface ISanPhamDangService
    {
        ...
        Task<PagedResponse<IEnumerable<SanPhamDangDto>>> GetAllProductsForDisplayAsync(int pageNumber = 1, int pageSize = 10, string? keyword = null, Guid? sanPhamChungId = null);
